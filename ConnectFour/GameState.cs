namespace ConnectFour
{
    public class GameState
    {
        ...
        public int ConsecutiveWinsPlayer1 { get; private set; }
        public int ConsecutiveWinsPlayer2 { get; private set; }
        ...
        public WinState CheckForWin()
        {
            ...
            WinState winningPlayer = WinState.No_Winner;
            ...
            foreach (var scenario in WinningPlaces)
            {
                ...
                {
                    winningPlayer = (WinState)TheBoard[scenario[0]];
                    break;
                }
            }

            if (winningPlayer == WinState.No_Winner && TheBoard.Count(x => x != 0) == 42)
            {
                winningPlayer = WinState.Tie;
            }

            // Update consecutive wins based on the winning player
            if (winningPlayer == WinState.Player1_Wins)
            {
                ConsecutiveWinsPlayer1++;
                ConsecutiveWinsPlayer2 = 0;
            }
            else if (winningPlayer == WinState.Player2_Wins)
            {
